...
directory = '../final/q1_document_retrieval'
...
merged_df.to_csv(directory + '/q1_merged_results.csv', index=False)
...
for i in range(len(merged_df)):
    print(i)
    question = merged_df['generated_question_1'][i]
    document = merged_df['document_question_1'][i]
    summary = generate_summary(document, question)
    results.append(summary)

merged_df['summary_1'] = results

merged_df.to_csv('../final/q1_with_summaries.csv', index = False)