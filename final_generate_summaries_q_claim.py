...
directory = '../final/q0_document_retrieval'
...
merged_df.to_csv(directory + '/q0_merged_results.csv', index=False)

df_filtered = merged_df[merged_df['document_weight_question_0'] != 'unweighted']
...
for i in merged_df.index:
    print(i)
    question = merged_df['generated_question_0'][i]
    document = merged_df['document_question_0'][i]
    summary = generate_summary(document, question)
    results.append(summary)

merged_df['summary_0'] = results



merged_df.to_csv('../final/q0_with_summaries.csv', index = False)